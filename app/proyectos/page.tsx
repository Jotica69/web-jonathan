      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-24 bg-[#0b1121] relative overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-8 relative z-10 reveal-on-scroll">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 text-white tracking-tighter">
                Proyectos <span className="text-cyan-300">reales</span>
            </h1>
      ...
      <section className="py-24 md:py-32 bg-[#0b1121] text-white relative overflow-hidden">
        <div className="max-w-[1200px] mx-auto px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 reveal-on-scroll">
                ...
                <div className="group cursor-pointer">
                    <div className="w-full aspect-[4/3] bg-[#141b2a] rounded-[2rem] mb-6 relative overflow-hidden border border-white/5 group-hover:border-blue-500/30 transition-colors">
                        <Image src="/DashboardDatos.jpg" alt="Panel del sistema Mocia" fill className="object-cover object-top group-hover:scale-105 transition-transform duration-700" />
                        <div className="absolute inset-0 bg-gradient-to-t from-[#0b1121]/70 via-transparent to-transparent"></div>
                        <span className="absolute bottom-4 left-4 text-[10px] uppercase tracking-widest font-bold px-3 py-1.5 bg-[#0b1121]/70 backdrop-blur-md text-cyan-300 rounded-full border border-white/10">Mocia SaaS</span>
                    </div>
                ...
                <div className="group cursor-pointer">
                    <div className="w-full aspect-[4/3] bg-[#141b2a] rounded-[2rem] mb-6 relative overflow-hidden border border-white/5 group-hover:border-cyan-500/30 transition-colors">
                        <Image src="/Inteligencia Ejecutiva.png" alt="Panel del dashboard financiero" fill className="object-cover object-top group-hover:scale-105 transition-transform duration-700" />
                        <div className="absolute inset-0 bg-gradient-to-t from-[#0b1121]/70 via-transparent to-transparent"></div>
                        <span className="absolute bottom-4 left-4 text-[10px] uppercase tracking-widest font-bold px-3 py-1.5 bg-[#0b1121]/70 backdrop-blur-md text-cyan-300 rounded-full border border-white/10">Dashboard App</span>
                    </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12 reveal-on-scroll">
                ...
                <div className="group cursor-pointer">
                    <div className="w-full aspect-[4/3] bg-[#141b2a] rounded-[2rem] mb-6 relative overflow-hidden border border-white/5 group-hover:border-blue-500/30 transition-colors">
                        <Image src="/Video.jpg" alt="Edición de video para marketing" fill className="object-cover object-center group-hover:scale-105 transition-transform duration-700" />
                        <div className="absolute inset-0 bg-gradient-to-t from-[#0b1121]/70 via-transparent to-transparent"></div>
                        <span className="absolute bottom-4 left-4 text-[10px] uppercase tracking-widest font-bold px-3 py-1.5 bg-[#0b1121]/70 backdrop-blur-md text-cyan-300 rounded-full border border-white/10">Video Marketing</span>
                    </div>
