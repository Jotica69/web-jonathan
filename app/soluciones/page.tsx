  ...
  return (
    <>
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-24 bg-hero-dark relative overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-8 relative z-10 text-center reveal-on-scroll">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold mb-6 text-white tracking-tighter">
                Soluciones que ya <span className="text-cyan-300">funcionan</span>
            </h1>
        ...
        <div className="max-w-[1200px] mx-auto px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-10 reveal-on-scroll">
                ...
                <div className="group relative bg-white border border-slate-200 hover:border-blue-200 rounded-[2rem] p-8 md:p-10 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,113,227,0.08)] overflow-hidden flex flex-col">
                    ...
                    <p className="text-slate-800 font-bold mb-8">
                        <strong className="text-blue-600">Resultado:</strong> Atiendes más mesas con menos personal y cero confusiones.
                    </p>
                    <a href="https://wa.me/573223663275?text=Me%20interesa%20QR%20Menu" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-[#0071e3] font-bold hover:text-blue-700 transition-colors group/link w-fit text-lg">
                ...
                <div className="group relative bg-white border border-slate-200 hover:border-blue-200 rounded-[2rem] p-8 md:p-10 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,113,227,0.08)] overflow-hidden flex flex-col">
                    ...
                    <p className="text-slate-800 font-bold mb-8">
                        <strong className="text-blue-600">Resultado:</strong> Sabes exactamente quiénes son tus mejores clientes y los haces volver sin esfuerzo.
                    </p>
                    <a href="https://wa.me/573223663275?text=Me%20interesa%20CRM%20Simple" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-[#0071e3] font-bold hover:text-blue-700 transition-colors group/link w-fit text-lg">
                ...
                <div className="group relative bg-white border border-slate-200 hover:border-blue-200 rounded-[2rem] p-8 md:p-10 transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_rgba(0,113,227,0.08)] overflow-hidden flex flex-col">
                    ...
                    <p className="text-slate-800 font-bold mb-8">
                        <strong className="text-blue-600">Resultado:</strong> Agenda llena sin contestar llamadas. Cero citas olvidadas.
                    </p>
                    <a href="https://wa.me/573223663275?text=Me%20interesa%20Reservas" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-[#0071e3] font-bold hover:text-blue-700 transition-colors group/link w-fit text-lg">
            ...
            <div className="text-center mt-16 reveal-on-scroll">
                <p className="text-slate-600 font-medium mb-6 text-lg">¿No encuentras lo que necesitas? Cuéntame tu problema y te armo algo a medida.</p>
      ...
      <a href="https://wa.me/573223663275" target="_blank" rel="noopener noreferrer" className="fixed bottom-6 right-6 z-[100] flex items-center gap-3 group">
        ...
        <span className="w-14 h-14 md:w-16 md:h-16 bg-[#10b981] hover:bg-[#059669] text-white rounded-full flex items-center justify-center shadow-[0_8px_30px_rgba(16,185,129,0.4)] hover:scale-110 active:scale-95 transition-all">
